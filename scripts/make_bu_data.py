...
# output_dir
parser.add_argument('--downloaded_feats', default='/apdcephfs/private_yuanenzhou/projects/data/trainval_36', help='downloaded feature directory')
parser.add_argument('--output_dir', default='/apdcephfs/private_yuanenzhou/projects/data/mscoco_fix/cocobu', help='output feature files')
