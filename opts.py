...
def parse_opt():
    ...
    # Model settings
    ############################################################################
    parser.add_argument('--caption_model', type=str, default="sat",
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer, sat')
    ############################################################################
    ...
    #######################################################################################
    parser.add_argument('--checkpoint_path', type=str, default='save/nsc-sat-6-from-nsc-seqkd-without-init',
    ...
    # misc
    #######################################################################################
    parser.add_argument('--id', type=str, default='nsc-sat-6-from-nsc-seqkd-without-init',
    ...
    parser.add_argument('--kd_weight', type=float, default=0,
                    help='The knowledge distillation weight.')
    parser.add_argument('--teacher_caption_model', type=str, default="show_tell",
    ...
    parser.add_argument('--K', type=int, default=6,
                    help='Number of parallel of SAT model.')
