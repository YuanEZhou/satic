...
# misc
#######################################################
parser.add_argument('--id', type=str, default='nsc-sat-4-from-nsc-seqkd-cocotest', 
...
if len(opt.id) == 0:
    opt.id = infos['opt'].id
ignore = ["id", "batch_size", "beam_size", "start_from", "language_eval", "block_trigrams", "input_json","input_fc_dir","input_att_dir","input_box_dir"]
